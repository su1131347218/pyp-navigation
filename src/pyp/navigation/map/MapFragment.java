 ...
 * @email 531724220@qq.com
 */
public class MapFragment extends Fragment implements PypBaseFragment  {
	...
	public void initViews(LayoutInflater inflater, ViewGroup container) {
		...
		//把静态地图显示的FrameLayout设置为不可左右移动
		MenuActivity context= ((MenuActivity) getActivity());
		context.getResideMenu().addIgnoredView(tilesViewlayout);
