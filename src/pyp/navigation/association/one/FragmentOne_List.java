...
import pyp.navigation.association.info.InfoFragment;
 ...
 */
public class FragmentOne_List extends Fragment implements PypBaseFragment {
	...
	OnItemClickListener mListViewListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			String association_NAME = list.get(position - 1).getName();
			// Log.i("qsuron", "onNewFragment : "+id);
			InfoFragment newFragment = new InfoFragment();
			Bundle args = new Bundle();
			args.putInt("id", Integer.parseInt(association_ID));
			args.putString("name", association_NAME);
			newFragment.setArguments(args);
			parentActivity.changeFragmentAddToBackStack(newFragment);
		}
	};
}
